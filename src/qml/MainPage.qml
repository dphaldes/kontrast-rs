...
Kirigami.ScrollablePage {
    ...
    ColumnLayout {
        ...
        Kirigami.Heading {
            ...
            Layout.fillWidth: true
            wrapMode: Text.WordWrap
            text: (Kontrast.contrast > 7 ? i18n("Perfect for normal and large text") : Kontrast.contrast > 4.5 ? i18n("Perfect for large text and good for normal text") : Kontrast.contrast > 3 ? i18n("Good for large text and bad for normal text") : i18n("Bad for large and normal text"))
        }
